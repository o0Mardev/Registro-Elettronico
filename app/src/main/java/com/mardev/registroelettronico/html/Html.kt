package com.mardev.registroelettronico.html
...
private fun HtmlElementsScope.Block(element: Element) {
    when (element.tagName().lowercase()) {
        "p" -> HtmlText(text = element.text(), style = TextStyle.Default.copy(color = MaterialTheme.colorScheme.onBackground))
        "h1" -> HtmlText(text = element.text(), style = TextStyle.Default.copy(color = MaterialTheme.colorScheme.onBackground))
        "h2" -> HtmlText(text = element.text(), style = TextStyle.Default.copy(color = MaterialTheme.colorScheme.onBackground))

        "h3" -> HtmlText(text = element.text(), style = TextStyle.Default.copy(color = MaterialTheme.colorScheme.onBackground))

        "h4" -> HtmlText(text = element.text(), style = TextStyle.Default.copy(color = MaterialTheme.colorScheme.onBackground))

        "div" -> Div(element)
        "td" -> HtmlText(text = element.text(), style = TextStyle.Default.copy(color = MaterialTheme.colorScheme.onBackground), modifier = Modifier.fillMaxWidth())
